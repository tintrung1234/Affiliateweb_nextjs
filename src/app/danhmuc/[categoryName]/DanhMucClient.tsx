            ...
            <div className="flex flex-col lg:flex-row mt-4">
                ...
                <div className="w-full lg:w-[80vw] flex flex-wrap justify-start px-2 mt-2">
                    <div className="flex flex-col sm:flex-row items-center w-full justify-end space-y-3 sm:space-y-0 sm:space-x-5">
                        <div className="relative flex items-center justify-between w-full ml-3" ref={dropdownRef}>
                            <div className="ml-3">
                                <Breadcrumb />
                            </div>
                            ...
                            {isOpen && (
                                <div className="absolute right-0 mt-2 w-44 bg-white rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 z-10">
                                    <div className="py-1">
                                        <a href="/profile" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Profile</a>
                                        <a href="/settings" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Settings</a>
                                        <a href="/logout" className="block px-4 py-2 text-sm text-gray-600 hover:bg-gray-100">Logout</a>
                                    </div>
                                </div>
                            )}
                        </div>
